...
public class JobA implements Job {//Scheduler에 의해 실행되는 실제 작업들은 Job Interface의 구현체들이 함
		...
		public void execute(JobExecutionContext context) throws JobExecutionException {
			...
			exchange = template.send("direct:aTypeSendRoute", exchange);
			System.out.println("JobA 실행됨");
